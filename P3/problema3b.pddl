...
;
; Este problema usa el mismo mapa y recursos que 3a, pero el dominio exige una
; Comunidad de 2 Hobbits y 1 Mago. El objetivo sigue siendo destruir el Anillo,
; por lo que la diferencia principal es el aumento de combinaciones posibles.
...
(define (problem tierra-media-problema3b)
  ...
  (:init
    ...
    ; Orden canonico entre Hobbits para romper simetrias. Con estos hechos,
    ; formarComunidad y viajarComunidad solo aceptan permutaciones en orden
    ; creciente, evitando planes equivalentes con Hobbits intercambiados.
