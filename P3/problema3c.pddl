...
; Estado inicial comun del Ejercicio 3. Comunidad: 3 Hobbits y 1 Mago.
;
; Este problema amplia 3b obligando a formar una Comunidad con 3 Hobbits y 1
; Mago. Los objetos, recursos y mapa se mantienen para poder comparar el impacto
; del numero de miembros sobre el tiempo de planificacion.

(define (problem tierra-media-problema3c)
  (:domain tierra-media-ej3c)
  ...
  (:init
    ...
    ; Orden canonico entre Hobbits para romper simetrias. El dominio usa una
    ; cadena hobbitAntes entre los tres Hobbits elegidos, evitando que Fast
    ; Downward explore permutaciones equivalentes de la misma Comunidad.
